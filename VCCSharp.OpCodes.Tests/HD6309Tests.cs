...
";
    ...
    public void TestPage3Opcodes()
    {
        ...
        var opcodes = new byte[]
        {
            ...
            //0x80, 0x81, 0x83, 0x86, 0x8B, 0x8C, 0x8D, 0x8E, 
            0x8F, 
            //0x90, 0x91, 0x93, 0x96, 0x97, 0x9B, 0x9C, 0x9D, 0x9E,
            0x9F, 
            //0xA0, 0xA1, 0xA3, 0xA6, 0xA7, 0xAB, 0xAC, 0xAD, 0xAE,
            0xAF, 
            //0xB0, 0xB1, 0xB3, 0xB6, 0xB7, 0xBB, 0xBC, 0xBD, 0xBE,
            0xBF, 
            //0xC0, 0xC1, 0xC6, 0xCB, 
    ...
    {
        byte opcode = 0x8f;
        var seeds = new Seeds { 182, 154, 213, 187, 200, 156, 151, 217, 223, 136, 82, 224, 50, 183, 59, 36, 163, 56, 213, 94 };
        var state = new TestState { CC = 0x94, PC = 0x12ab, S = 0x59e, U = 0x4be5, DP = 0xa1, D = 0x8081, X = 0xfa9a, Y = 0x734d, MD = 0x61, W = 0x797c, V = 0xf8fe };
