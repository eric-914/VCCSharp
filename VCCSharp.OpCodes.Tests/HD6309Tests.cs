...
";
    ...
    {
        byte opcode = 0xaf;
        var seeds = new Seeds { 245, 117, 206, 125, 67, 131, 77, 203, 28, 56, 94, 41, 202, 175, 223, 109, 138, 231, 252, 227 };
        var state = new TestState { CC = 0x5d, PC = 0x674, S = 0x2632, U = 0x34e0, DP = 0x2a, D = 0xd1a8, X = 0x2f01, Y = 0xb2e9, MD = 0xaf, W = 0x515b, V = 0x50f5 };
