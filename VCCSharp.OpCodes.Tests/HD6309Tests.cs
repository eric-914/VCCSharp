...
";
    ...
    {
        byte opcode = 0xad;
        var seeds = new Seeds { 121, 167, 79, 84, 34, 182, 152, 189, 223, 215, 8, 253, 230, 244, 149, 98, 118, 75, 231, 49 };
        var state = new TestState { CC = 0x2b, PC = 0x2bb3, S = 0x2386, U = 0x3a79, DP = 0xa9, D = 0x1e88, X = 0x37d, Y = 0x765, MD = 0xa0, W = 0xcb8, V = 0x9165 };
