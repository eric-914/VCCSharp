...
";
    ...
    {
        byte opcode = 0x8f;
        var seeds = new Seeds { 204, 238, 38, 117, 112, 94, 21, 183, 222, 80, 227, 84, 48, 68, 170, 192, 170, 176, 168, 65 };
        var state = new TestState { CC = 0xcd, PC = 0x119e, S = 0xe62a, U = 0xe3b9, DP = 0x56, D = 0xadc2, X = 0xac2f, Y = 0xb9cd, MD = 0x86, W = 0x1279, V = 0x28b5 };
