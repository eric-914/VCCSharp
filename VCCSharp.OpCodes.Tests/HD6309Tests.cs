...
";
    ...
    {
        byte opcode = 0x9f;
        var seeds = new Seeds { 93, 190, 124, 39, 179, 51, 55, 179, 179, 172, 28, 135, 85, 62, 234, 165, 242, 245, 181, 237 };
        var state = new TestState { CC = 0x21, PC = 0x243a, S = 0xb2a5, U = 0xf23d, DP = 0xe7, D = 0x46c8, X = 0x3b33, Y = 0x5692, MD = 0xfc, W = 0x13ed, V = 0x180b };
