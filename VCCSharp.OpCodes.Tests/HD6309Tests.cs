...
";
    ...
    {
        byte opcode = 0x8e;
        var seeds = new Seeds { 167, 46, 26, 170, 246, 20, 5, 96, 211, 29, 31, 106, 238, 203, 253, 169, 163, 175, 84, 173 };
        var state = new TestState { CC = 0x5f, PC = 0x4a4e, S = 0x3042, U = 0x4220, DP = 0x82, D = 0xb317, X = 0xaab4, Y = 0xe8e8, MD = 0x9c, W = 0x5e7, V = 0x5955 };
