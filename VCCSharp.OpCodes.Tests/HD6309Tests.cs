...
";
    ...
    public void TestPage3Opcodes()
    {
        ...
        var opcodes = new byte[]
        {
            ...
            //0x80, 0x81, 0x83, 0x86, 0x8B, 0x8C,
            0x8D,
            0x8E,
            //0x8F, 
            //0x90, 0x91, 0x93, 0x96, 0x97, 0x9B, 0x9C,
            0x9D, 
            0x9E,
            //0x9F, 
            //0xA0, 0xA1, 0xA3, 0xA6, 0xA7, 0xAB, 0xAC,
            0xAD, 
            0xAE,
            //0xAF, 
            //0xB0, 0xB1, 0xB3, 0xB6, 0xB7, 0xBB, 0xBC,
            0xBD,
            0xBE,
            //0xBF, 
            //0xC0, 0xC1, 0xC6, 0xCB, 
    ...
    {
        byte opcode = 0x8e;
        var seeds = new Seeds { 227, 153, 60, 234, 149, 169, 133, 83, 159, 187, 53, 142, 171, 41, 111, 149, 219, 182, 186, 90 };
        var state = new TestState { CC = 0x4f, PC = 0xd16b, S = 0x2892, U = 0xc12a, DP = 0x50, D = 0x95fb, X = 0xd3b5, Y = 0xf9b2, MD = 0x51, W = 0x9410, V = 0x4d7 };
