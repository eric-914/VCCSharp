...
internal class Page2Opcodes6809
{
    ...
    public IOpCode[] OpCodes => new IOpCode[256]
    {
        ...
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_           ,_103F_Swi2_I,
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_           ,_           ,
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_           ,_           ,
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_           ,_           ,
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_           ,_           ,
        _           ,_            ,_           ,_1083_Cmpd_M,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_108C_Cmpy_M ,_           ,_108E_Ldy_M ,_           ,
        _           ,_            ,_           ,_1093_Cmpd_D,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_109C_Cmpy_D ,_           ,_109E_Ldy_D ,_109F_Sty_D ,
        _           ,_            ,_           ,_10A3_Cmpd_X,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_10AC_Cmpy_X ,_           ,_10AE_Ldy_X ,_10AF_Sty_X ,
        _           ,_            ,_           ,_10B3_Cmpd_E,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_10BC_Cmpy_E ,_           ,_10BE_Ldy_E ,_10BF_Sty_E ,
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_10CE_Lds_I ,_           ,
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_10DE_Lds_D ,_10DF_Sts_D ,
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_10EE_Lds_X ,_10EF_Sts_X ,
        _           ,_            ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_           ,_            ,_           ,_10FE_Lds_E ,_10FF_Sts_E 
    };
}
