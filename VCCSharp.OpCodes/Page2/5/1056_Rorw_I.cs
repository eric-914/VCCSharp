...
/// <summary>
/// <code>1046/RORW/INHERENT</code>
/// Rotate 16-Bit Accumulator <c>W</c> Right through Carry
/// <code>C → b15 → ... → b0 → C’</code>
/// </summary>
/// <remarks>
/// The <c>RORW</c> instruction rotates the contents of the <c>W</c> accumulator to the right by one bit, through the Carry (<c>C</c>) bit of the CC register (effectively a 17-bit rotation). 
