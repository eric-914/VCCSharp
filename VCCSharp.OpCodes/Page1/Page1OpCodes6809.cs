...
internal class Page1OpCodes6809
{
    ...
    private IOpCode _10_Page_2 => new _10_Page_2_6809();
    private IOpCode _11_Page_3 => new _11_Page_3_6809();
    ...
    private IOpCode _1E_Exg__M => new _1E_Exg_M_6809();
    private IOpCode _1F_Tfr__M => new _1F_Tfr_M_6809();
    ...
    private IOpCode _3B_Rti__I => new _3B_Rti_I_6809();
    private IOpCode _3C_Cwai_I => new _3C_Cwai_I();
    private IOpCode _3D_Mul__I => new _3D_Mul_I();
    //3E
    private IOpCode _3F_Swi__I => new _3F_Swi_I_6809();
