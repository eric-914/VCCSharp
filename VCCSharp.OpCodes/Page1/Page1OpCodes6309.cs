...
internal class Page1OpCodes6309
{
    ...
    private IOpCode _01_Oim__D => new _01_Oim_D(_cpu);
    private IOpCode _02_Aim__D => new _02_Aim_D(_cpu);
    private IOpCode _03_Com__D => new _03_Com_D(_cpu);
    private IOpCode _04_Lsr__D => new _04_Lsr_D(_cpu);
    private IOpCode _05_Eim__D => new _05_Eim_D(_cpu);
    ...
    private IOpCode _0B_Tim__D => new _0B_Tim_D(_cpu);
    ...
    private IOpCode _1E_Exg__M => new _1E_Exg_M_6309(_cpu);
    private IOpCode _1F_Tfr__M => new _1F_Tfr_M_6309(_cpu);
    ...
    private IOpCode _3B_Rti__I => new _3B_Rti_I_6309(_cpu);
    private IOpCode _3C_Cwai_I => new _3C_Cwai_I(_cpu);
    private IOpCode _3D_Mul__I => new _3D_Mul_I(_cpu);
    //3E
    private IOpCode _3F_Swi__I => new _3F_Swi_I_6309(_cpu);
    ...
    private IOpCode _61_Oim__X => new _61_Oim_X(_cpu);
    private IOpCode _62_Aim__X => new _62_Aim_X(_cpu);
    private IOpCode _63_Com__X => new _63_Com_X(_cpu);
    private IOpCode _64_Lsr__X => new _64_Lsr_X(_cpu);
    private IOpCode _65_Eim__X => new _65_Eim_X(_cpu);
    ...
    private IOpCode _6B_Tim__X => new _6B_Tim_X(_cpu);
    ...
    private IOpCode _71_Oim__E => new _71_Oim_E(_cpu);
    private IOpCode _72_Aim__E => new _72_Aim_E(_cpu);
    private IOpCode _73_Com__E => new _73_Com_E(_cpu);
    private IOpCode _74_Lsr__E => new _74_Lsr_E(_cpu);
    private IOpCode _75_Eim__E => new _75_Eim_E(_cpu);
    ...
    private IOpCode _7B_Tim__E => new _7B_Tim_E(_cpu);
    ...
    private IOpCode _CD_Ldq__M => new _CD_Ldq_M(_cpu);
