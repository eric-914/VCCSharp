...
internal class Page1OpCodes6309
{
    ...
    private IOpCode _01_Oim_D => new _01_Oim_D(_cpu);
    private IOpCode _02_Aim_D => new _02_Aim_D(_cpu);
    private IOpCode _03_Com_D => new _03_Com_D(_cpu);
    private IOpCode _04_Lsr_D => new _04_Lsr_D(_cpu);
    private IOpCode _05_Eim_D => new _05_Eim_D(_cpu);
    ...
    private IOpCode _0B_Tim_D => new _0B_Tim_D(_cpu);
    ...
    private IOpCode _14_Sexw_I => new _14_Sexw_I(_cpu);
    //15
    ...
    private IOpCode _1E_Exg_M => new _1E_Exg_M_6309(_cpu);
    private IOpCode _1F_Tfr_M => new _1F_Tfr_M_6309(_cpu);
    ...
    private IOpCode _3B_Rti_I => new _3B_Rti_I_6309(_cpu);
    private IOpCode _3C_Cwai_I => new _3C_Cwai_I(_cpu);
    private IOpCode _3D_Mul_I => new _3D_Mul_I(_cpu);
    //3E
    private IOpCode _3F_Swi_I => new _3F_Swi_I_6309(_cpu);
    ...
    private IOpCode _61_Oim_X => new _61_Oim_X(_cpu);
    private IOpCode _62_Aim_X => new _62_Aim_X(_cpu);
    private IOpCode _63_Com_X => new _63_Com_X(_cpu);
    private IOpCode _64_Lsr_X => new _64_Lsr_X(_cpu);
    private IOpCode _65_Eim_X => new _65_Eim_X(_cpu);
    ...
    private IOpCode _6B_Tim_X => new _6B_Tim_X(_cpu);
    ...
    private IOpCode _71_Oim_E => new _71_Oim_E(_cpu);
    private IOpCode _72_Aim_E => new _72_Aim_E(_cpu);
    private IOpCode _73_Com_E => new _73_Com_E(_cpu);
    private IOpCode _74_Lsr_E => new _74_Lsr_E(_cpu);
    private IOpCode _75_Eim_E => new _75_Eim_E(_cpu);
    ...
    private IOpCode _7B_Tim_E => new _7B_Tim_E(_cpu);
    ...
    private IOpCode _CD_Ldq_M => new _CD_Ldq_M(_cpu);
    ...
    public IOpCode[] OpCodes => new IOpCode[256]
    {
        ...
        _10_Page_2, _11_Page_3, _12_Nop_I , _13_Sync_I, _14_Sexw_I, __________, _16_Lbra_R, _17_Lbsr_R, __________, _19_Daa_I , _1A_Orcc_M, __________, _1C_Andcc_M, _1D_Sex_I , _1E_Exg_M , _1F_Tfr_M ,
