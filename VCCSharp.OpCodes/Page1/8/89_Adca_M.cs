...
///     
/// The ADCA instruction is most often used to perform addition of the subsequent bytes of a multi-byte addition. 
...
{
    internal _89_Adca_M(MC6809.IState cpu) : base(cpu) { }
