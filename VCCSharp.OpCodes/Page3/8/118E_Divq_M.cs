...
/// 
/// See Also: DIVD
internal class _118E_Divq_M : OpCode6309, IOpCode
{
    public int CycleCount => 34;
    ...
    public void Exec()
    {
        ...
        {
            Cycles = 4 + Exceptions.DivideByZero(); // 4 cycles to read word and increment PC and compare to zero.
            return;
        }
