...
namespace VCCSharp.Models.CPU.OpCodes.Page3
{
    ...
    /// BEOR r,sBit,dBit,addr   DIRECT              1134         7 / 6       4
    /// </summary>
    /// <remarks>
    /// The BEOR instruction Exclusively ORs the value of a specified bit in either the A, B or CC registers with a specified bit in memory. 
