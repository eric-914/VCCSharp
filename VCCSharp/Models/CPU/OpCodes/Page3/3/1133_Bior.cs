...
namespace VCCSharp.Models.CPU.OpCodes.Page3
{
    ...
    /// BIOR r,sBit,dBit,addr   DIRECT              1133         7 / 6       4
    /// </summary>
    /// <remarks>
    /// The BIOR instruction ORs the value of a specified bit in either the A, B or CC registers with the inverted value of a specified bit in memory. 
