namespace VCCSharp.Models.Keyboard
{
    ...
    {
        private static KeyTranslationEntry[] _keyTranslationsCompact;

#pragma warning disable IDE1006 // Naming Styles
        private static readonly byte[][] KeyTranslationsCompactRaw =
        {
            ...
            new byte[] {Define.DIK_TAB, 0, 64, 1, 0, 0}, //   HOME (CLEAR)
            new byte[] {Define.DIK_GRAVE, 0, 64, 2, 0, 0}, //   ESCAPE (BREAK)
            ...
            new byte[] {Define.DIK_LBRACKET, Define.DIK_LSHIFT, 64, 4, 32, 4}, //   new byte[] { (CoCo CTRL ,)
