    ...
    public class IOBus : IIOBus
    {
        ...
        public byte port_read(ushort address)
        {
            ...
            switch (port)
            {
                ...
                case 2:
                case 3:
                    value = _modules.MC6821.MC6821_pia0_read(port); //MC6821 P.I.A  Keyboard access $FF00-$FF03
                    break;
                ...
                case 0x22:
                case 0x23:
                    value = _modules.MC6821.MC6821_pia1_read(port); //MC6821 P.I.A	Sound and VDG Control 
                    break;
        ...
        public void port_write(byte data, ushort address)
        {
            ...
            switch (port)
            {
                ...
                case 2:
                case 3:
                    _modules.MC6821.MC6821_pia0_write(data, port);	//MC6821 P.I.A  Keyboard access $FF00-$FF03
                    break;
                ...
                case 0x22:
                case 0x23:
                    _modules.MC6821.MC6821_pia1_write(data, port);	//MC6821 P.I.A	Sound and VDG Control 
                    break;
