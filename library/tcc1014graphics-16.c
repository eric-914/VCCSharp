...
extern "C" {
    ...
    void __cdecl UpdateScreen16(EmuState* emuState)
  {
    ...
    if ((gs->HorzCenter != 0) && (gs->BorderChange > 0))
      ...
      {
        emuState->pSurface16[x + (((emuState->LineCounter + gs->VertCenter) * 2) * (emuState->SurfacePitch))] = gs->BorderColor16;

        if (!emuState->ScanLines)
          emuState->pSurface16[x + (((emuState->LineCounter + gs->VertCenter) * 2 + 1) * (emuState->SurfacePitch))] = gs->BorderColor16;

        emuState->pSurface16[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((emuState->LineCounter + gs->VertCenter) * 2) * (emuState->SurfacePitch))] = gs->BorderColor16;

        if (!emuState->ScanLines)
          emuState->pSurface16[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((emuState->LineCounter + gs->VertCenter) * 2 + 1) * (emuState->SurfacePitch))] = gs->BorderColor16;
      }
    ...
    case 0: //Width 80
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        emuState->pSurface16[yStride += 1] = TextPallete[pixel >> 7];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel >> 6) & 1];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel >> 5) & 1];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel >> 4) & 1];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel >> 3) & 1];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel >> 2) & 1];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel >> 1) & 1];
        emuState->pSurface16[yStride += 1] = TextPallete[pixel & 1];
    ...
    case 63:
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        TextPallete[1] = gs->Pallete16Bit[8 + ((attributes & 56) >> 3)];
        TextPallete[0] = gs->Pallete16Bit[attributes & 7];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel & 128) / 128];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel & 64) / 64];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel & 32) / 32];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel & 16) / 16];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel & 8) / 8];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel & 4) / 4];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel & 2) / 2];
        emuState->pSurface16[yStride += 1] = TextPallete[(pixel & 1)];
      }
      break;
    ...
    case 128 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=1
      {
        ...
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 7)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 6)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 5)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 4)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 3)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 2)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 1)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & WidePixel];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 15)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 14)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 13)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 12)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 11)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 10)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 9)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 8)];
    ...
    case 128 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        WidePixel = emuState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 6)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 4)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 2)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[3 & WidePixel];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 14)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 12)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 10)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 8)];
    ...
    case 128 + 32: //Bpp=2 Sr=0 4BPP Stretch=1
      ...
      {
        WidePixel = emuState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[15 & (WidePixel >> 4)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[15 & WidePixel];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[15 & (WidePixel >> 12)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[15 & (WidePixel >> 8)];
    ...
    case 192 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      ...
      {
        WidePixel = emuState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 7))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 6))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 5))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 4))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 3))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 2))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 1))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & WidePixel)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 15))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 14))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 13))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 12))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 11))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 10))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 9))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 8))];
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=2
      {
        ...
        { //Pcolor
          for (bit = 7; bit >= 0; bit--)
          {
            ...
            case 3:
              color = 3;
              emuState->pSurface16[yStride - 1] = gs->Afacts16[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                emuState->pSurface16[yStride + emuState->SurfacePitch - 1] = gs->Afacts16[gs->ColorInvert][3];
              }

              emuState->pSurface16[yStride] = gs->Afacts16[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                emuState->pSurface16[yStride + emuState->SurfacePitch] = gs->Afacts16[gs->ColorInvert][3];
              }
            ...
            emuState->pSurface16[yStride += 1] = gs->Afacts16[gs->ColorInvert][color];

            if (!emuState->ScanLines) {
              emuState->pSurface16[yStride + emuState->SurfacePitch] = gs->Afacts16[gs->ColorInvert][color];
            }
    ...
    case 192 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        WidePixel = emuState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 6))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 4))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 2))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & WidePixel)];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 14))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 12))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 10))];
        emuState->pSurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 8))];
...
extern "C" {
    ...
    void __cdecl DrawTopBorder16(EmuState* emuState)
  {
    ...
    {
      emuState->pSurface16[x + ((emuState->LineCounter * 2) * emuState->SurfacePitch)] = gs->BorderColor16;

      if (!emuState->ScanLines) {
        emuState->pSurface16[x + ((emuState->LineCounter * 2 + 1) * emuState->SurfacePitch)] = gs->BorderColor16;
      }
    }
  }
}
...
extern "C" {
    ...
    void __cdecl DrawBottomBorder16(EmuState* emuState)
  {
    ...
    for (unsigned short x = 0; x < emuState->WindowSize.x; x++)
    {
      emuState->pSurface16[x + (2 * (emuState->LineCounter + gs->LinesperScreen + gs->VertCenter) * emuState->SurfacePitch)] = gs->BorderColor16;

      if (!emuState->ScanLines) {
        emuState->pSurface16[x + emuState->SurfacePitch + (2 * (emuState->LineCounter + gs->LinesperScreen + gs->VertCenter) * emuState->SurfacePitch)] = gs->BorderColor16;
      }
    }
  }
}