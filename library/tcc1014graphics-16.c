    ...
    void __cdecl UpdateScreen16(EmuState* emuState)
  {
    ...
    case 0: //Width 80
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        textPalette[1] = gs->Palette16Bit[8 + ((attributes & 56) >> 3)];
        textPalette[0] = gs->Palette16Bit[attributes & 7];
    ...
    case 127:
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam++)
      {
        ...
        case 0:
          ...
          textPalette[0] = gs->Palette16Bit[gs->TextBGPalette];
          textPalette[1] = gs->Palette16Bit[gs->TextFGPalette];
        ...
        case 2:
        case 3:
          textPalette[1] = gs->Palette16Bit[(character & 112) >> 4];
          textPalette[0] = gs->Palette16Bit[8];
    ...
    case 128 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=1
      {
        ...
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 7)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 6)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 5)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 4)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 3)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 2)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 1)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & widePixel];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 15)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 14)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 13)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 12)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 11)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 10)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 9)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[1 & (widePixel >> 8)];
    ...
    case 128 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[3 & (widePixel >> 6)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[3 & (widePixel >> 4)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[3 & (widePixel >> 2)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[3 & widePixel];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[3 & (widePixel >> 14)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[3 & (widePixel >> 12)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[3 & (widePixel >> 10)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[3 & (widePixel >> 8)];
    ...
    case 128 + 32: //Bpp=2 Sr=0 4BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[15 & (widePixel >> 4)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[15 & widePixel];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[15 & (widePixel >> 12)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[15 & (widePixel >> 8)];
    ...
    case 192 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 7))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 6))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 5))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 4))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 3))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 2))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 1))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & widePixel)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 15))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 14))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 13))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 12))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 11))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 10))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 9))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (1 & (widePixel >> 8))];
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=2
      {
        ...
        { //Pcolor
          for (bit = 7; bit >= 0; bit--)
          {
            ...
            case 3:
              color = 3;
              graphicsSurfaces->pSurface16[yStride - 1] = gs->Afacts16[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                graphicsSurfaces->pSurface16[yStride + emuState->SurfacePitch - 1] = gs->Afacts16[gs->ColorInvert][3];
              }

              graphicsSurfaces->pSurface16[yStride] = gs->Afacts16[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                graphicsSurfaces->pSurface16[yStride + emuState->SurfacePitch] = gs->Afacts16[gs->ColorInvert][3];
              }
            ...
            graphicsSurfaces->pSurface16[yStride += 1] = gs->Afacts16[gs->ColorInvert][color];

            if (!emuState->ScanLines) {
              graphicsSurfaces->pSurface16[yStride + emuState->SurfacePitch] = gs->Afacts16[gs->ColorInvert][color];
            }
    ...
    case 192 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (3 & (widePixel >> 6))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (3 & (widePixel >> 4))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (3 & (widePixel >> 2))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (3 & widePixel)];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (3 & (widePixel >> 14))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (3 & (widePixel >> 12))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (3 & (widePixel >> 10))];
        graphicsSurfaces->pSurface16[yStride += 1] = gs->Palette16Bit[gs->PaletteIndex + (3 & (widePixel >> 8))];
