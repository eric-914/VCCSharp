    ...
    void __cdecl UpdateScreen32(EmuState* emuState)
  {
    ...
    case 0: //Width 80
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        textPalette[1] = gs->Palette32Bit[8 + ((attributes & 56) >> 3)];
        textPalette[0] = gs->Palette32Bit[attributes & 7];
    ...
    case 127:
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam++)
      {
        ...
        case 0:
          ...
          textPalette[0] = gs->Palette32Bit[gs->TextBGPalette];
          textPalette[1] = gs->Palette32Bit[gs->TextFGPalette];
        ...
        case 2:
        case 3:
          textPalette[1] = gs->Palette32Bit[(character & 112) >> 4];
          textPalette[0] = gs->Palette32Bit[8];
    ...
    case 128 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=1
      {
        ...
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 7)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 6)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 5)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 4)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 3)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 2)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 1)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & widePixel];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 15)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 14)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 13)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 12)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 11)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 10)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 9)];
        szSurface32[yStride += 1] = gs->Palette32Bit[1 & (widePixel >> 8)];
    ...
    case 128 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        szSurface32[yStride += 1] = gs->Palette32Bit[3 & (widePixel >> 6)];
        szSurface32[yStride += 1] = gs->Palette32Bit[3 & (widePixel >> 4)];
        szSurface32[yStride += 1] = gs->Palette32Bit[3 & (widePixel >> 2)];
        szSurface32[yStride += 1] = gs->Palette32Bit[3 & widePixel];
        szSurface32[yStride += 1] = gs->Palette32Bit[3 & (widePixel >> 14)];
        szSurface32[yStride += 1] = gs->Palette32Bit[3 & (widePixel >> 12)];
        szSurface32[yStride += 1] = gs->Palette32Bit[3 & (widePixel >> 10)];
        szSurface32[yStride += 1] = gs->Palette32Bit[3 & (widePixel >> 8)];
    ...
    case 128 + 32: //Bpp=2 Sr=0 4BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        szSurface32[yStride += 1] = gs->Palette32Bit[15 & (widePixel >> 4)];
        szSurface32[yStride += 1] = gs->Palette32Bit[15 & widePixel];
        szSurface32[yStride += 1] = gs->Palette32Bit[15 & (widePixel >> 12)];
        szSurface32[yStride += 1] = gs->Palette32Bit[15 & (widePixel >> 8)];
    ...
    case 192 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 7))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 6))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 5))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 4))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 3))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 2))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 1))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & widePixel)];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 15))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 14))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 13))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 12))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 11))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 10))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 9))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (1 & (widePixel >> 8))];
    ...
    case 192 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (3 & (widePixel >> 6))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (3 & (widePixel >> 4))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (3 & (widePixel >> 2))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (3 & widePixel)];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (3 & (widePixel >> 14))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (3 & (widePixel >> 12))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (3 & (widePixel >> 10))];
        szSurface32[yStride += 1] = gs->Palette32Bit[gs->PaletteIndex + (3 & (widePixel >> 8))];
