...
extern "C" {
    ...
    void __cdecl UpdateScreen8(EmuState* emuState)
  {
    ...
    if ((gs->HorzCenter != 0) && (gs->BorderChange > 0)) {
      ...
      {
        emuState->PTRsurface8[x + (((emuState->LineCounter + gs->VertCenter) * 2) * emuState->SurfacePitch)] = gs->BorderColor8;

        if (!emuState->ScanLines) {
          emuState->PTRsurface8[x + (((emuState->LineCounter + gs->VertCenter) * 2 + 1) * emuState->SurfacePitch)] = gs->BorderColor8;
        }

        emuState->PTRsurface8[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((emuState->LineCounter + gs->VertCenter) * 2) * emuState->SurfacePitch)] = gs->BorderColor8;

        if (!emuState->ScanLines) {
          emuState->PTRsurface8[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((emuState->LineCounter + gs->VertCenter) * 2 + 1) * emuState->SurfacePitch)] = gs->BorderColor8;
        }
      }
    }
    ...
    case 0: //Width 80
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        emuState->PTRsurface8[yStride += 1] = TextPallete[pixel >> 7];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel >> 6) & 1];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel >> 5) & 1];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel >> 4) & 1];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel >> 3) & 1];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel >> 2) & 1];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel >> 1) & 1];
        emuState->PTRsurface8[yStride += 1] = TextPallete[pixel & 1];
    ...
    case 63:
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        TextPallete[1] = gs->Pallete8Bit[8 + ((attributes & 56) >> 3)];
        TextPallete[0] = gs->Pallete8Bit[attributes & 7];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel & 128) / 128];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel & 64) / 64];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel & 32) / 32];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel & 16) / 16];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel & 8) / 8];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel & 4) / 4];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel & 2) / 2];
        emuState->PTRsurface8[yStride += 1] = TextPallete[(pixel & 1)];
      }
      break;
    ...
    case 128 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=1
      {
        ...
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 7)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 6)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 5)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 4)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 3)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 2)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 1)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & WidePixel];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 15)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 14)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 13)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 12)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 11)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 10)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 9)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 8)];
    ...
    case 128 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        WidePixel = emuState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 6)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 4)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 2)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & WidePixel];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 14)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 12)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 10)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 8)];
    ...
    case 128 + 32: //Bpp=2 Sr=0 4BPP Stretch=1
      ...
      {
        WidePixel = emuState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[15 & (WidePixel >> 4)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[15 & WidePixel];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[15 & (WidePixel >> 12)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[15 & (WidePixel >> 8)];
    ...
    case 192 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      ...
      {
        WidePixel = emuState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 7))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 6))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 5))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 4))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 3))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 2))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 1))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & WidePixel)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 15))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 14))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 13))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 12))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 11))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 10))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 9))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 8))];
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=2
      {
        ...
        { //Pcolor
          for (bit = 7;bit >= 0;bit--)
          {
            ...
            case 3:
              color = 3;
              emuState->PTRsurface8[yStride - 1] = gs->Afacts8[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                emuState->PTRsurface8[yStride + emuState->SurfacePitch - 1] = gs->Afacts8[gs->ColorInvert][3];
              }

              emuState->PTRsurface8[yStride] = gs->Afacts8[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                emuState->PTRsurface8[yStride + emuState->SurfacePitch] = gs->Afacts8[gs->ColorInvert][3];
              }
            ...
            emuState->PTRsurface8[yStride += 1] = gs->Afacts8[gs->ColorInvert][color];

            if (!emuState->ScanLines) {
              emuState->PTRsurface8[yStride + emuState->SurfacePitch] = gs->Afacts8[gs->ColorInvert][color];
            }
    ...
    case 192 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        WidePixel = emuState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 6))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 4))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 2))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & WidePixel)];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 14))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 12))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 10))];
        emuState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 8))];
...
extern "C" {
  __declspec(dllexport)
    void __cdecl DrawTopBorder8(EmuState* emuState)
  {
    GraphicsState* gs = GetGraphicsState();
    ...
    {
      emuState->PTRsurface8[x + ((emuState->LineCounter * 2) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;

      if (!emuState->ScanLines) {
        emuState->PTRsurface8[x + ((emuState->LineCounter * 2 + 1) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;
      }
    }
  }
}
...
extern "C" {
  __declspec(dllexport)
    void __cdecl DrawBottomBorder8(EmuState* emuState)
  {
    GraphicsState* gs = GetGraphicsState();
    ...
    for (unsigned short x = 0; x < emuState->WindowSize.x; x++)
    {
      emuState->PTRsurface8[x + (2 * (emuState->LineCounter + gs->LinesperScreen + gs->VertCenter) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;

      if (!emuState->ScanLines) {
        emuState->PTRsurface8[x + emuState->SurfacePitch + (2 * (emuState->LineCounter + gs->LinesperScreen + gs->VertCenter) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;
      }
    }
  }
}