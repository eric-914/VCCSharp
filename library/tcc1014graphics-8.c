    ...
    void __cdecl UpdateScreen8(EmuState* emuState)
  {
    ...
    case 0: //Width 80
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        textPalette[1] = gs->Palette8Bit[8 + ((attributes & 56) >> 3)];
        textPalette[0] = gs->Palette8Bit[attributes & 7];
    ...
    case 127:
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam++)
      {
        ...
        case 0:
          ...
          textPalette[0] = gs->Palette8Bit[gs->TextBGPalette];
          textPalette[1] = gs->Palette8Bit[gs->TextFGPalette];
        ...
        case 2:
        case 3:
          textPalette[1] = gs->Palette8Bit[(character & 112) >> 4];
          textPalette[0] = gs->Palette8Bit[8];
    ...
    case 128 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=1
      {
        ...
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 7)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 6)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 5)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 4)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 3)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 2)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 1)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & widePixel];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 15)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 14)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 13)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 12)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 11)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 10)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 9)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[1 & (widePixel >> 8)];
    ...
    case 128 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[3 & (widePixel >> 6)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[3 & (widePixel >> 4)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[3 & (widePixel >> 2)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[3 & widePixel];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[3 & (widePixel >> 14)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[3 & (widePixel >> 12)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[3 & (widePixel >> 10)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[3 & (widePixel >> 8)];
    ...
    case 128 + 32: //Bpp=2 Sr=0 4BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[15 & (widePixel >> 4)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[15 & widePixel];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[15 & (widePixel >> 12)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[15 & (widePixel >> 8)];
    ...
    case 192 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 7))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 6))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 5))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 4))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 3))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 2))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 1))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & widePixel)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 15))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 14))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 13))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 12))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 11))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 10))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 9))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (1 & (widePixel >> 8))];
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=2
      {
        ...
        { //Pcolor
          for (bit = 7;bit >= 0;bit--)
          {
            ...
            case 3:
              color = 3;
              graphicsSurfaces->pSurface8[yStride - 1] = gs->Afacts8[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                graphicsSurfaces->pSurface8[yStride + emuState->SurfacePitch - 1] = gs->Afacts8[gs->ColorInvert][3];
              }

              graphicsSurfaces->pSurface8[yStride] = gs->Afacts8[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                graphicsSurfaces->pSurface8[yStride + emuState->SurfacePitch] = gs->Afacts8[gs->ColorInvert][3];
              }
            ...
            graphicsSurfaces->pSurface8[yStride += 1] = gs->Afacts8[gs->ColorInvert][color];

            if (!emuState->ScanLines) {
              graphicsSurfaces->pSurface8[yStride + emuState->SurfacePitch] = gs->Afacts8[gs->ColorInvert][color];
            }
    ...
    case 192 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        widePixel = wRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (3 & (widePixel >> 6))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (3 & (widePixel >> 4))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (3 & (widePixel >> 2))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (3 & widePixel)];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (3 & (widePixel >> 14))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (3 & (widePixel >> 12))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (3 & (widePixel >> 10))];
        graphicsSurfaces->pSurface8[yStride += 1] = gs->Palette8Bit[gs->PaletteIndex + (3 & (widePixel >> 8))];
...
extern "C" {
    ...
    void __cdecl DrawTopBorder8(EmuState* emuState)
  {
    ...
    {
      graphicsSurfaces->pSurface8[x + ((emuState->LineCounter * 2) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;

      if (!emuState->ScanLines) {
        graphicsSurfaces->pSurface8[x + ((emuState->LineCounter * 2 + 1) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;
      }
    }
  }
}
...
extern "C" {
    ...
    void __cdecl DrawBottomBorder8(EmuState* emuState)
  {
    ...
    for (unsigned short x = 0; x < emuState->WindowSize.x; x++)
    {
      graphicsSurfaces->pSurface8[x + (2 * (emuState->LineCounter + gs->LinesperScreen + gs->VertCenter) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;

      if (!emuState->ScanLines) {
        graphicsSurfaces->pSurface8[x + emuState->SurfacePitch + (2 * (emuState->LineCounter + gs->LinesperScreen + gs->VertCenter) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;
      }
    }
  }
}