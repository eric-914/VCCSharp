...
extern "C" {
    ...
    void __cdecl UpdateScreen8(EmuState* emuState)
  {
    ...
    if ((gs->HorzCenter != 0) && (gs->BorderChange > 0)) {
      ...
      {
        gs->pSurface8[x + (((emuState->LineCounter + gs->VertCenter) * 2) * emuState->SurfacePitch)] = gs->BorderColor8;

        if (!emuState->ScanLines) {
          gs->pSurface8[x + (((emuState->LineCounter + gs->VertCenter) * 2 + 1) * emuState->SurfacePitch)] = gs->BorderColor8;
        }

        gs->pSurface8[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((emuState->LineCounter + gs->VertCenter) * 2) * emuState->SurfacePitch)] = gs->BorderColor8;

        if (!emuState->ScanLines) {
          gs->pSurface8[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((emuState->LineCounter + gs->VertCenter) * 2 + 1) * emuState->SurfacePitch)] = gs->BorderColor8;
        }
      }
    }
    ...
    case 0: //Width 80
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        gs->pSurface8[yStride += 1] = TextPallete[pixel >> 7];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel >> 6) & 1];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel >> 5) & 1];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel >> 4) & 1];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel >> 3) & 1];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel >> 2) & 1];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel >> 1) & 1];
        gs->pSurface8[yStride += 1] = TextPallete[pixel & 1];
    ...
    case 63:
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        TextPallete[1] = gs->Pallete8Bit[8 + ((attributes & 56) >> 3)];
        TextPallete[0] = gs->Pallete8Bit[attributes & 7];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel & 128) / 128];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel & 64) / 64];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel & 32) / 32];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel & 16) / 16];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel & 8) / 8];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel & 4) / 4];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel & 2) / 2];
        gs->pSurface8[yStride += 1] = TextPallete[(pixel & 1)];
      }
      break;
    ...
    case 128 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=1
      {
        ...
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 4)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 3)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 2)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 1)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & WidePixel];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 15)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 14)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 13)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 12)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 11)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 10)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 9)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 8)];
    ...
    case 128 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //2bbp Stretch=1
      {
        ...
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[3 & WidePixel];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 14)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 12)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 10)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 8)];
    ...
    case 128 + 32: //Bpp=2 Sr=0 4BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //4bbp Stretch=1
      {
        ...
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[15 & (WidePixel >> 8)];
    ...
    case 192 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=1
      {
        ...
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 4))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 3))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 2))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 1))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & WidePixel)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 15))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 14))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 13))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 12))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 11))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 10))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 9))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 8))];
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=2
      {
        ...
        { //Pcolor
          for (bit = 7;bit >= 0;bit--)
          {
            ...
            case 3:
              color = 3;
              gs->pSurface8[yStride - 1] = gs->Afacts8[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                gs->pSurface8[yStride + emuState->SurfacePitch - 1] = gs->Afacts8[gs->ColorInvert][3];
              }

              gs->pSurface8[yStride] = gs->Afacts8[gs->ColorInvert][3];

              if (!emuState->ScanLines) {
                gs->pSurface8[yStride + emuState->SurfacePitch] = gs->Afacts8[gs->ColorInvert][3];
              }
            ...
            gs->pSurface8[yStride += 1] = gs->Afacts8[gs->ColorInvert][color];

            if (!emuState->ScanLines) {
              gs->pSurface8[yStride + emuState->SurfacePitch] = gs->Afacts8[gs->ColorInvert][color];
            }
    ...
    case 192 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //2bbp Stretch=1
      {
        ...
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & WidePixel)];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 14))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 12))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 10))];
        gs->pSurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 8))];
...
extern "C" {
    ...
    void __cdecl DrawTopBorder8(EmuState* emuState)
  {
    ...
    {
      gs->pSurface8[x + ((emuState->LineCounter * 2) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;

      if (!emuState->ScanLines) {
        gs->pSurface8[x + ((emuState->LineCounter * 2 + 1) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;
      }
    }
  }
}
...
extern "C" {
    ...
    void __cdecl DrawBottomBorder8(EmuState* emuState)
  {
    ...
    for (unsigned short x = 0; x < emuState->WindowSize.x; x++)
    {
      gs->pSurface8[x + (2 * (emuState->LineCounter + gs->LinesperScreen + gs->VertCenter) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;

      if (!emuState->ScanLines) {
        gs->pSurface8[x + emuState->SurfacePitch + (2 * (emuState->LineCounter + gs->LinesperScreen + gs->VertCenter) * emuState->SurfacePitch)] = gs->BorderColor8 | 128;
      }
    }
  }
}